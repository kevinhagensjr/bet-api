 ...
 */
 async setUser(userObject){
   ...
   try{
     ...
     console.error('ERROR, failed to add user, ' + e);
     return false;
   }
 }
 /*
 ...
 */
 async update(userID,userObject){
   if(!userObject){
     console.error('ERROR, failed to update user, userObject null');
     return false;
   }
 ...
 */
 async getUser(userID){
   ...
   try{
     ...
     console.error('ERROR, failed to get user, ' + e);
     return false;
   }
 }
 ...
 */
 async getPhoto(userID){
   ...
   try{
     ...
     console.error('ERROR, failed to get photo, ' + e)
     return false;
   }
 }
 ...
 */
 async getPassword(userID){
   ...
   try{
     ...
     console.error('ERROR, failed to get password, ' + e);
     return false;
   }
 }
 ...
 */
 async getRegion(userID){
   ...
   try{
     ...
     console.error('ERROR, failed to get region, ' + e);
     return false;
   }
 }
 ...
 */
 async getFacebookID(userID){
   ...
   try{
     ...
     console.error('ERROR, failed to get facebook account, ' + e);
     return false;
   }
 }
 ...
 */
 async getDevices(userID){
   ...
   try{
     ...
     console.error('ERROR, failed to get user devices, ' + e);
     return false;
   }
 }
 ...
 async search(search){
   ...
   try{
     ...
     console.error('ERROR: Failed to search for user');
     return [];
   }
 }
}
